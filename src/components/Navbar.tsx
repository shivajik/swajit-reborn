        ...
        <div className="hidden lg:flex items-center gap-1">
          {navLinks.map((l) => (
            <button
              ...
              className="px-3 py-2 text-sm font-medium text-primary-foreground/80 hover:text-accent transition-colors font-heading uppercase tracking-wide"
            >
              {l.label}
            </button>
          ))}
          <Button
            ...
            className="ml-4 bg-accent text-accent-foreground hover:bg-accent/90 font-heading font-bold uppercase text-xs tracking-wider"
          >
        ...
        <div className="lg:hidden bg-primary border-t border-primary-foreground/10 pb-4">
          {navLinks.map((l) => (
            <button
              key={l.href}
              onClick={() => scrollTo(l.href)}
              className="block w-full text-left px-6 py-3 text-primary-foreground/80 hover:text-accent hover:bg-primary-foreground/5 font-heading uppercase text-sm tracking-wide"
            >
              {l.label}
            </button>
          ))}
          <div className="px-6 pt-2">
            <Button
              onClick={() => scrollTo("#contact")}
              className="w-full bg-accent text-accent-foreground hover:bg-accent/90 font-heading font-bold uppercase text-xs"
            >
              <Phone className="w-3.5 h-3.5 mr-1" /> Request Quote
            </Button>
          </div>
