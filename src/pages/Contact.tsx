...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone",
      lines: [settings.company_phone, ...(settings.company_whatsapp && settings.company_whatsapp !== settings.company_phone ? [settings.company_whatsapp + " (WhatsApp)"] : []), ...(settings.company_fax ? [settings.company_fax + " (Fax)"] : [])],
    },
    {
      icon: Mail,
      title: "Email",
