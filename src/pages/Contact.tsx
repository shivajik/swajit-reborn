...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone",
      lines: [settings.company_phone, ...(settings.company_whatsapp && settings.company_whatsapp !== settings.company_phone ? [settings.company_whatsapp + " ( Whatsapp/Cell Number)"] : []), ...(settings.company_fax ? [settings.company_fax + " (Fax)"] : [])],
    },
    {
      icon: Mail,
      title: "Email",
      ...
      <section className="bg-secondary border-t border-border">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
          <div className="rounded-xl overflow-hidden border border-border h-[400px]">
            <iframe
              src={settings.company_map_link || "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3962.7611254518!2d75.206099!3d19.8546842!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdb99185f3478cf%3A0x394c137fa53b8ae4!2sSWAJIT%20ENGINEERING%20PRIVATE%20LIMITED!5e1!3m2!1sen!2sin!4v1778743269364!5m2!1sen!2sin"}
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
